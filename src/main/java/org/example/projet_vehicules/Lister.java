...
public class Lister implements Initializable {
    ...
    @FXML
    private TableColumn<Enregistrement, String> anneech;
    @Override
    ...
    public void afficher() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                ligne.add(new Enregistrement(id, marque, modele, type,annee));
            }
            ...
            anneech.setCellValueFactory(new PropertyValueFactory<>("annee"));
