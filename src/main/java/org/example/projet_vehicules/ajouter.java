...
public class ajouter {
    ...
    @FXML
    private TextField annee_vehicule,idV;
    ...
    public void ajout_enregistrer(ActionEvent actionEvent) {
        Data data=new Data();
        data.inserer(ID_vehicule.getText(), Type_vehicule.getText(), Marque_vehicule.getText(), modele_vehicule.getText(),annee_vehicule.getText());
